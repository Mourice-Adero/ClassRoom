                    ...
                    <div class="container page__container page-section">
                        ...
                        <div class="card mb-lg-32pt">
                            ...
                            <div class="card-body">
                                ...
                                <div class="chart">
                                    <canvas id="ordersChart" class="chart-canvas js-update-chart-bar" data-chart-legend="#ordersChartLegend" data-chart-prefix="" data-chart-suffix="" data-chart-line-background-color="gradient:primary"></canvas>
                                </div>
                            </div>
                        </div>
