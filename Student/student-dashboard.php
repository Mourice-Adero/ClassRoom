                                                            ...
                                                            <div class="mdk-reveal__content">
                                                                <div class="card-body">
                                                                    <div class="d-flex">
                                                                        <div class="flex">
                                                                            <a class="card-title"
                                                                               href="student-take-course.php">Learn Angular fundamentals</a>
                                                            ...
                                                            <div class="mdk-reveal__content">
                                                                <div class="card-body">
                                                                    <div class="d-flex">
                                                                        <div class="flex">
                                                                            <a class="card-title"
                                                                               href="student-take-course.php">Build an iOS Application in Swift</a>
                                                                            <small class="text-50 font-weight-bold mb-4pt">Elijah Murray</small>
                                                                        </div>
                                                                        <a href="student-take-course.php"
                                                                           data-toggle="tooltip"
                                                            ...
                                                            <div class="mdk-reveal__content">
                                                                <div class="card-body">
                                                                    <div class="d-flex">
                                                                        <div class="flex">
                                                                            <a class="card-title"
                                                                               href="student-take-course.php">Build a WordPress Website</a>
                                                                            <small class="text-50 font-weight-bold mb-4pt">Elijah Murray</small>
                                                                        </div>
                                                                        <a href="student-take-course.php"
                                                                           data-toggle="tooltip"
                                                            ...
                                                            <div class="mdk-reveal__content">
                                                                <div class="card-body">
                                                                    <div class="d-flex">
                                                                        <div class="flex">
                                                                            <a class="card-title"
                                                                               href="student-take-course.php">Become a React Native Developer</a>
                                                                            <small class="text-50 font-weight-bold mb-4pt">Elijah Murray</small>
                                                                        </div>
                                                                        <a href="student-take-course.php"
                                                                           data-toggle="tooltip"
                                        ...
                                        <div class="card card-group-row__card card-sm">
                                            <div class="card-body d-flex align-items-center">
                                                ...
                                                <div class="flex mr-12pt">
                                                    <a class="card-title"
                                                       href="student-take-quiz.php">Introduction to TypeScript</a>
                                    ...
                                    <div class="card-group-row__col col-md-6">
                                        ...
                                        <div class="card card-group-row__card card-sm">
                                            <div class="card-body d-flex align-items-center">
                                                ...
                                                <div class="flex mr-12pt">
                                                    <a class="card-title"
                                                       href="student-take-quiz.php">Angular Fundamentals</a>
                                                    <div class="card-subtitle text-50">3 days ago</div>
                                                </div>
                                                <div class="d-flex flex-column align-items-center">
                        ...
                        <div class="mdk-drawer__content top-navbar">
                            <div class="sidebar sidebar-dark-pickled-bluewood sidebar-left sidebar-p-t"
                                ...
                                <ul class="sidebar-menu nav nav-tabs">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button"
                                           href="dashboard-my-achievements.php">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button"
                                           href="dashboard-track-progress.php">
